      ...
      <div className="rounded-lg border border-neutral-200/80 bg-white p-8 shadow-sm">
        ...
        {orders.length === 0 ? (
          <div className="py-10 text-center">
            <p className="font-body mb-4 text-neutral-700">
              You haven&apos;t placed any orders yet.
            </p>
            <Link
              href="/shop"
              className="font-body inline-flex items-center justify-center rounded-md bg-brand-navy px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-brand-gold hover:text-brand-navy"
            >
              Browse products
            </Link>
          </div>
